...
- (void)button_clickUpdateButton
{
  ...
  //  NSString *str = @"http://itunes.apple.com/us/app";
    //[NSString stringWithFormat:@"http://itunes.apple.com/us/app/id%@",appid];
...
- (void)setupUpdateViewUI
{
    ...
    versionLabel.font = MEDIUM_FONT(14);
    ...
    updateButton.titleLabel.font = MEDIUM_FONT(18);
