...
// v 1.0.0分享网页
- (void)shareWebPageToPlatformType:(UMSocialPlatformType)platformType WithModel:(ShareMsgModel *)model
{
    //创建分享消息对象
...
//友盟分享图片
- (void)shareImageToPlatformType:(UMSocialPlatformType)platformType WithModel:(ShareMsgModel *)model
{
    //创建分享消息对象
    UMSocialMessageObject *messageObject = [UMSocialMessageObject messageObject];
