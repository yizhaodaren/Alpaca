...
//当前章节
@property (copy, nonatomic) NSString *currentChapterName;

//当前书的Id
@property (assign, nonatomic) NSUInteger currentBookId;

//当前章节数
@property (assign, nonatomic) NSUInteger currentChapterIndex;

//章节Id
@property (assign, nonatomic) NSUInteger currentChapterId;
...
/**
 通过 章节chapterNum_chapterId来获取章节信息
